package com.legends.dtedumia.cellkits;
...
import com.legends.dtedumia.cellkits.cell.*;
...
public class DTEdumiaCellKits {
	...
	public static final CellKit SPARSE = new CellKit(new ResourceLocation(DynamicTreesEdumia.MOD_ID, "sparse")) {
		...
		public SimpleVoxmap getLeafCluster() {
			return DTEdumiaLeafClusters.SPARSE;
		}
	...
	public static final CellKit POPLAR = new CellKit(new ResourceLocation(DynamicTreesEdumia.MOD_ID, "poplar")) {
	...
	public static final CellKit WIDE_DARK_OAK = new CellKit(DynamicTreesEdumia.location("wide_dark_oak")) {
		...
		@Override
		public SimpleVoxmap getLeafCluster() {
			return DTEdumiaLeafClusters.WIDE_DARK_OAK;
		}
